...
{
    Reference ref1("ref1", nullptr, Vec3{1, 0, 0}, Quaternion{0, 0, 0});
    Reference ref2("ref2", &ref1, Vec3{0, 1, 0}, Quaternion{0, 0, 0});
    Reference ref3("ref3", &ref2, Vec3{0, 0, 1}, Quaternion{0, 0, 0});
...
{
    Reference ref1("ref1", nullptr, Vec3{1, 0, 0}, Quaternion{0, 0, pi/2});
    Reference ref2("ref2", &ref1, Vec3{1, 0, 0}, Quaternion{0, -pi/2, 0});
    Reference ref3("ref3", &ref2, Vec3{1, 0, 0}, Quaternion{-pi/2, 0, -pi/2});
    test_basic_transformations(ref1);
    test_basic_transformations(ref2);
    test_basic_transformations(ref3);
    require_close_position(ref3.global_from_local_pos(Vec3{1, 2, 3}), Vec3(2, 3, 4));
