...
TEST_CASE("Power Gain of auto With X-Translation", "[Gain]")
{
    ...
    double const power_gain_actual = antenna::calc_power_gain(antenna1, antenna2, lambda, {});
    ...
    complex_t const voltage_gain_actual = antenna::calc_voltage_gain(antenna1, antenna2, lambda, {});
