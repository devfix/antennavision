...
TEST_CASE("Power Gain: Isotropic Transmitter and Isotropic Receiver")
{
    SECTION("Power Gain: Isotropical Radiators with X-translation", "[Gain]")
    {
        ...
        components::Antenna antenna1 = components::Radiator::IsotropicRadiator::create("auto1", "ref1");

        reference::Reference ref2{.id = "ref2", .pos = {1000, 0, 0}};
        components::Antenna antenna2 = components::Radiator::IsotropicRadiator::create("auto2", "ref2");
        components::antenna::rebind_origin_pointers({antenna1, antenna2}, {ref1, ref2});
        std::get<components::Radiator>(antenna2).ms_elv = nullptr; // disable pre-calculated mean-squared elv to test numerical computation

        double const r = (ref1.global_from_local_pos(POS_ZERO) - ref2.global_from_local_pos(POS_ZERO)).norm();
        double const power_gain_actual =
            components::antenna::calc_power_gain(antenna1, antenna2, sim_params.system_wavelength, uc(antenna1), uc(antenna2), sim_params);
        ...
        Complex const voltage_gain_actual =
            components::antenna::calc_voltage_gain(antenna1, antenna2, sim_params.system_wavelength, uc(antenna1), uc(antenna2), sim_params);
...
TEST_CASE("Power Gain: Isotropic Transmitter and Hertzian Receiver")
{
    SECTION("Power Gain: Isotropical Radiators with X-translation", "[Gain]")
    {
        ...
        reference::Reference ref2{.id = "ref2", .pos = {1000, 0, 0}};
        components::Antenna antenna2 = components::Radiator::HertzianDipole::create("auto2", "ref2");
        components::antenna::rebind_origin_pointers({antenna1, antenna2}, {ref1, ref2});
        std::get<components::Radiator>(antenna2).ms_elv = nullptr; // disable pre-calculated mean-squared elv to test numerical computation
...
TEST_CASE("Power Gain: Hertzian Transmitter and Isotropic Receiver")
{
    ...
    {
        reference::Reference ref1{.id = "ref1"};
        components::Antenna antenna1 = components::Radiator::HertzianDipole::create("auto1", "ref1");
        std::get<components::Radiator>(antenna1).ms_elv = nullptr; // disable pre-calculated mean-squared elv to test numerical computation
