...
namespace eval::output
{
    ...
    {
        std::string name = std::format("{}", __func__);
        std::println("Creating plot: {}", name);
    ...
    // -----------------------------------------------------------------------------
    template void voltagefield_over_geometry<VoltageField>(ComplexScalarField<VoltageField> const&, geometry::Geometry const&, sweep::Sweep const&);

} // nanamespace eval::output