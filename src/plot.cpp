...
void plot::gain_over_phase(path const& dir_plot, NdArray const &phases, std::vector<std::tuple<std::reference_wrapper<const NdArray>, std::string>> const &gains, std::string_view const name, std::string_view const title)
{
